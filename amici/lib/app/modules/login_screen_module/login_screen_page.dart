                    ...
                    children: [
                      ...
                      SubmitButtonHelper(
                          ...
                          onTap: (){
                            ...
                            if(Validators().validateEmailForm(loginScreenController.emailController.text) != null){
                              Get.toNamed(Routes.HOME_SCREEN);
                              // DioClient.get().toAst(Validators().validateEmailForm(loginScreenController.emailController.text).toString());
                              return;
                            }
                            else if(loginScreenController.passwordController.text.isEmpty==true){
                               // DioClient.get().toAst("Password can't be empty");
                            }
