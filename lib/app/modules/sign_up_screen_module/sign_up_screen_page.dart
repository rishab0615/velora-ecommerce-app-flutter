                          ...
                          children: [
                            ...
                            SubmitButtonHelper(
                              ...
                              onTap: () {
                                ...
                                // Validations...
                                if (Validators().validateFirstName(signUpScreenController.companyNameController.text) != null) {
                                  DioClient.get().toAst(Validators().validateFirstName(signUpScreenController.companyNameController.text).toString());
                print("EMpty field");
                                  return;
                                }
